...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <main className="ml-[35%] p-4 min-h-screen pt-16 mt-16 relative w-[65%]">
        <nav
          ...
          <div className="flex items-center space-x-4">
            <div className="hover:cursor-pointer hover:scale-105 transition-all duration-200">
              <a
                ...
                className={`inline-flex items-center px-4 py-2 font-normal rounded-xl hover:bg-gray-100 transition duration-200 border-2 border-gray-200  ${
