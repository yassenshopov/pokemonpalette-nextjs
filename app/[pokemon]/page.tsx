...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/components/ui/tooltip'; // Import Tooltip and TooltipContent
...
export default function Page({ params }: PageProps) {
  ...
  const { colors, shiny, form, setColors } = useColors();
      ...
      try {
        ...
        if (speciesName) {
          ...
          if (englishEntries.length > 0) {
            setPokemonDescription(englishEntries[0].flavor_text.replace(/\f/g, ' '));
            setCurrentDescriptionIndex(0);
          }
        }
      } catch (error) {
  ...
  const handlePreviousDescription = () => {
    ...
    const newIndex = (currentDescriptionIndex - 1 + descriptions.length) % descriptions.length;
    setCurrentDescriptionIndex(newIndex);
    setPokemonDescription(descriptions[newIndex].flavor_text.replace(/\f/g, ' '));
  };
              ...
              <>
                        ...
                        <div className="flex justify-between items-center gap-2">
                          <div className="flex-1">
                            <select
                              ...
                              style={{ outline: 'none' }}
                            >
                              <option value="rgb" className="text-foreground bg-background">
                                RGB
                              </option>
                              <option value="hex" className="text-foreground bg-background">
                                HEX
                              </option>
                              <option value="hsl" className="text-foreground bg-background">
                                HSL
                              </option>
                            </select>
                          ...
                          <Popover
                            ...
                            onOpenChange={open => {
                              if (open) {
                                ...
                                navigator.clipboard.writeText(convertColor(color, colorFormat));
                          ...
                          >
                            <PopoverTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                className={`hover:bg-white/10 ${getContrastColor(color).text}`}
                              >
                      ...
                      <CardContent className={`p-8 ${getContrastColor(colors[0]).overlay}`}>
                        <div className="flex flex-col md:flex-row-reverse gap-8">
                          <div className="flex-1 space-y-6">
                            <div className="space-y-4">
                              ...
                              <div className="flex gap-2">
                                {pokemonTypes.map((type, index) => {
                                  ...
                                  const { text: textColor, overlay } = getContrastColor(bgColor);
                            ...
                            <div className="space-y-4">
                              <p className={`text-lg ${getContrastColor(colors[0]).text}`}>
                                {pokemonDescription}
                              </p>
                            ...
                            `}
                              ...
                              >
                                {availableVersions.map(version => (
                                  ...
                                  >
                                    Pokemon {version.charAt(0).toUpperCase() + version.slice(1)}
                                  </option>
                                ))}
                              </select>
                            </div>
                            ...
                            >
                              <div className="relative w-64 h-64">
                                <Image
                                  ...
                                  onMouseEnter={e => {
                                    e.currentTarget.style.filter = 'contrast(1) brightness(1)';
                                  }}
                                  onMouseLeave={e => {
                                    e.currentTarget.style.filter = 'contrast(0) brightness(0)';
                                  }}
                                />
                              </div>
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <Card style={{ backgroundColor: colors[0], opacity: 0.9 }}>
                    <CardContent className={`p-8 ${getContrastColor(colors[0]).overlay}`}>
                      <h2 className={`text-2xl font-bold mb-4 ${getContrastColor(colors[0]).text}`}>
                        Primary Color Usage
                      </h2>
                  ...
                  <Card style={{ backgroundColor: colors[1], opacity: 0.9 }}>
                    <CardContent className={`p-8 ${getContrastColor(colors[1]).overlay}`}>
                      <h2 className={`text-2xl font-bold mb-4 ${getContrastColor(colors[1]).text}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <Card>
                      <CardContent className="p-6 space-y-4">
                        ...
                        <div className="space-y-4">
                          ...
                          >
                            <span className={getContrastColor(colors[0]).text}>Primary Button</span>
                          </button>
                          <button
                            className={`w-full px-4 py-2 rounded-lg transition-all hover:opacity-90 
                    ...
                    <Card>
                      <CardContent className="p-6 space-y-4 relative">
                        ...
                        >
                          <h4 className={`font-medium ${getContrastColor(selectedColorCard).text}`}>
                            Card Title
                          </h4>
                          <p
                      ...
                      <CardContent className="p-6 space-y-4">
                        ...
                        <Accordion type="single" collapsible className="w-full gap-4">
                          <AccordionItem value="item-1" className="w-full mb-4">
                            <AccordionTrigger
                              className={`${getContrastColor(colors[0]).text} p-4 rounded-lg`}
                              style={{ backgroundColor: colors[0] }}
                            >
                              Primary Section
                            </AccordionTrigger>
                          ...
                          <AccordionItem value="item-2">
                            <AccordionTrigger
                              className={`${getContrastColor(colors[1]).text} p-4 rounded-lg`}
                              style={{ backgroundColor: colors[1] }}
                            >
                              Secondary Section
                            </AccordionTrigger>
                      ...
                      <CardContent className="p-6 space-y-4">
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            ...
                            >
                              <span className={getContrastColor(colors[0]).text}>Open Dialog</span>
                            </Button>
                          </AlertDialogTrigger>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This is an example of how the color palette can be applied to
                              ...
                              >
                                <div
                                  className={`flex items-center justify-center w-full h-24  opacity-90 ${
                                    getContrastColor(colors[index % colors.length]).overlay
                                  }`}
                                  style={{
                                    backgroundColor:
                                      getContrastColor(colors[index % colors.length]).text ===
                                      'text-white'
                                        ? '#ffffff'
                                        : '#000000',
                                  }}
                                ...
                                <span className={`text-lg ${textColor} font-medium p-4`}>
                        ...
                        >
                          <div className="flex items-center">
                            <span
                              ...
                              style={{
                                color: getContrastColor(selectedColorNotification).text,
                              }}
                            >
                              <Info
                                className={`h-5 w-5 ${
                            ...
                            <p className={getContrastColor(selectedColorNotification).text}>
