...
const FeaturedDesigns = ({ designs, isLiked, toggleLike }: FeaturedDesignsProps) => {
  ...
  const handleViewAllFeatured = () => {
    // Navigate to explore page with featured filter
    router.push('/explore?filter=featured');
  };
  ...
  return (
    <div className="mb-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="ghost" className="text-primary" onClick={handleViewAllFeatured}>
          View All Featured
        </Button>
      </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Featured on {new Date(design.date).toLocaleDateString()}
                    </p>
                  </div>
                  <Button
                    variant="ghost"
